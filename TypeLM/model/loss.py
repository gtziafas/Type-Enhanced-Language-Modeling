...
# 	wp = torch.rand(32, 12, 5).view(-1, 5)
# 	tp = torch.rand(32, 12, 27).view(-1, 27)
# 	wt = torch.randint(size=(32, 12), low=0, high=5).view(-1)
# 	tt = torch.randint(size=(32, 12), low=0, high=27).view(-1)
# 	wm = torch.randint(size=(32, 12), low=0, high=2).view(-1)
